...
This is an iOS app project using Swift/SwiftUI. Codex cannot modify `.xcodeproj` files or add SPM packages directly. Flag these manual steps clearly for the user with step-by-step Xcode UI instructions. Don't attempt CLI workarounds for Xcode-specific tasks.
